		...
		if (editor.settings.link_title !== false) {
			listOptions = {
                ...
                // Insert content when the window form is submitted
                  //tinyMCE.activeEditor.windowManager.alert('Value selected:' + this.value());
                  //console.log(this.value());//alert('changed');
			...
			onSubmit: function(e) {
				...
				function insertLink() {
					...
					if (anchorElm) {
						...
						if(data.type == 'jsmol') {
						var newcontent = '<div class="well well-sm"><h3>'+data.text+'</h3><script type="text/javascript" src="../../../jmol/jsmol/JSmol.min.js"></script>' + 
...
/*				if ((editor.settings.link_assume_external_targets && !/^\w+:/i.test(href)) ||
	...
	editor.addButton('ooclink', {
	    ...
	    text: 'Chem',
        icon: false,
		tooltip: 'Insert 3D Structure or Spectra',
		shortcut: 'Meta+K',
